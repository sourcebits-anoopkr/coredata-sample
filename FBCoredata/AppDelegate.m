...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    {
        SBFacebookViewController* pFacebookVC = nil;
        
        if(pFacebookVC){
            pFacebookVC = nil;
        }
        pFacebookVC = [[SBFacebookViewController alloc]init];
        
        UINavigationController *navigationController = (UINavigationController *)self.window.rootViewController;
        ViewController *controller = (ViewController *)navigationController.topViewController;
        controller.IsCachedToken = YES;
        pFacebookVC.m_delegate=controller;
        ...
        [FBSession openActiveSessionWithReadPermissions:@[@"basic_info",@"user_education_history"]
                                      ...
                                      completionHandler:^(FBSession *session, FBSessionState state, NSError *error) {
                                          ...
                                          [pFacebookVC sessionStateChanged:session state:state error:error];
                                      }];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeUrl = [NSURL fileURLWithPath: [[self applicationDocumentsDirectory]
                                               stringByAppendingPathComponent: @"MyBrian.sqlite"]];
    NSError *error = nil;
